...
export function AnalyticsSection({ searchCount, analytics, onRefresh }: AnalyticsSectionProps) {
          ...
          <CardContent className="space-y-4">
            ...
            <div className="space-y-3">
              <div className="flex items-center justify-between p-3 bg-green-50 rounded-lg">
                ...
                <Badge className="bg-green-100 text-green-700">{analytics.successRate.toFixed(1)}%</Badge>
              </div>
        ...
        <Card className="shadow-lg border-0 bg-white/80 backdrop-blur-sm">
          ...
          <CardContent className="space-y-2 text-sm text-gray-600">
            <div className="flex justify-between">
              <span>Status:</span>
              <Badge className="bg-green-100 text-green-700">Loading...</Badge>
            </div>
          </CardContent>
        </Card>
      </div>
  ...
  return (
    <div className="space-y-6">
      ...
      <CommunicationStats onRefresh={onRefresh} />
