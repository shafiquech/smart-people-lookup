...
export function AnalyticsSection({ searchCount }: AnalyticsSectionProps) {
      ...
      <Card className="shadow-lg border-0 bg-white/80 backdrop-blur-sm">
        ...
        <CardContent className="space-y-4">
          ...
          <div className="text-center p-4 bg-gradient-to-r from-indigo-50 to-purple-50 rounded-lg">
            <div className="text-3xl font-bold text-indigo-600 mb-1">{searchCount}</div>
          ...
          <div className="space-y-3">
            ...
            <div className="flex items-center justify-between p-3 bg-blue-50 rounded-lg">
              <div className="flex items-center gap-2">
                ...
                <span className="text-sm font-medium">Profiles Found</span>
              </div>
